...
(function () {
    ...
    var HTML = `<div class="fstar-standalone-editor">
    ...
    <div class="row">
      ...
      <span class="command-line-args-cell">
        <input class="command-line-args" type="text"
               value="--z3refresh --fstar_home /fstar" />
      </span>
      <span class="run-cell">
  ...
  <pre class="stdout"></pre>
    ...
    var Client = FStar.CLI.Client = function(host) {
        ...
        this.editor = FStar.ClientUtils.setupEditor(this.$editor[0],  "");
    };
