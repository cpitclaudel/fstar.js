...
(function() {
    ...
    STATE_UI[SNIPPET_STATE.PENDING] = {
        ...
        progressBarClassName: "fstar-progress-bar-element fstar-progress-bar-pending"
    };
    STATE_UI[SNIPPET_STATE.BUSY] = {
        label: "typechecking…",
        editorClassName: "fstar-snippet fstar-snippet-busy",
        progressBarClassName: "fstar-progress-bar-element fstar-progress-bar-busy"
    };
    STATE_UI[SNIPPET_STATE.DONE] = {
        label: "typechecked ✓",
        editorClassName: "fstar-snippet fstar-snippet-done",
        progressBarClassName: "fstar-progress-bar-element fstar-progress-bar-done"
    };
    ...
    Snippet.prototype.updateClassAndLabel = function(label) {
        if (this.state !== null) {
            ...
            this.ui.$progressBarElement.attr("class", ui.progressBarClassName);
            this.ui.$statusLabel.text(label || ui.label);
        } else {
            this.ui.$top.attr("class", "fstar-snippet");
            this.ui.$progressBarElement.attr("class", "fstar-progress-bar-element");
    ...
    Snippet.prototype.complain = function(message) {
        console.log(message);
        this.ui.$complaintBox.text(message).show().delay(2000).fadeOut(200);
    };
    ...
    Instance.prototype.onBlur = function(cm, _event) {
    ...
    Instance.prototype.prepareFStarSnippet = function(id, editorDiv) {
        ...
        editor.on("blur", _.bind(this.onBlur, this));
    ...
    Instance.prototype.prepareFStarSnippets = function() {
        return $(".fstar").map(_.bind(function(id, editorDiv) {
